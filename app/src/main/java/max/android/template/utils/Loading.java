...
import max.android.template.databinding.ViewLoadingBinding;
...
public class Loading {
    ...
    public static void show() {
        if (Loading.dialog == null) {
            ViewLoadingBinding binding = DataBindingUtil.inflate(LayoutInflater.from(Max.ins().activity()), R.layout.view_loading, null, false);
            AlertDialog.Builder build = new AlertDialog.Builder(Max.ins().activity(), R.style.AppTheme_Loading);
